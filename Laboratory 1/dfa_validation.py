...
-să mutați codul de validare a unei configurări într-o metodă/funcție. Funcția primește ca parametru un nume de fișier și
returnează listele (cele 3 secțiuni) și un cod de eroare, poate mai elaborat, din care să reiasă ce eroare a apărut
(e.g. nu există fișierul, lipsește o secțiune, tranzițiile au erori, etc ...)"""
...
if validation_message != "Valid config file":  # se afiseaza eroarea gasita
    ...
    print("Status:", validation_message)
    print("The alphabet is", l_sigma)
    print("The states are", l_state)
    print("The transitions are", l_trans)
