...
2. Implement a library/program in a programming language of
your choosing to load and validate a configuration file of a TM with two heads and one tape. Also implement a simulator for this type of TM"""
    ...
    while current_state != 'qaccept' and current_state != "qreject":
        ...
        for transition in l_transitions:
            ...
            if l_sol[first_head_pos + 1] == "(h2)" or l_sol[second_head_pos + 1] == "(h1)":  # capetele se afla pe aceeasi pozitie pe banda
                aux += 1
            if transition[0] == current_state and l_sol[first_head_pos + aux] == heads_symbols_trans[0] \
                    and l_sol[second_head_pos + aux] == heads_symbols_trans[1]:  # daca starea de inceput a tranzitiei coincide cu starea curenta si daca simbolurile de la capetele benzii coincid cu simbolurile de pe banda ale tranzitiei
